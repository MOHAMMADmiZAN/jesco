...
<head>
    ...
    <!-- Add site Favicon -->
    <link rel="shortcut icon" href="{{asset('assets/frontend/images/favicon/favicon.ico')}}" type="image/png">


{{--    <!-- vendor css (Icon Font) -->--}}
{{--    <!-- <link rel="stylesheet" href="{{asset('assets/frontend/')}}/css/vendor/bootstrap.bundle.min.css" />--}}
{{--    <link rel="stylesheet" href="{{asset('assets/frontend/')}}/css/vendor/pe-icon-7-stroke.css" />--}}
...
{{--    <link rel="stylesheet" href="{{asset('assets/frontend/')}}/css/plugins/nice-select.css" />--}}
{{--    <link rel="stylesheet" href="{{asset('assets/frontend/')}}/css/plugins/venobox.css" /> -->--}}
                                        ...
                                        <ul class="menu-banner w-100">
                                            <li>
                                                <a class="p-0" href="shop-left-sidebar.html"><img
                                                        ...
                                                        src="{{asset('assets/frontend/')}}/images/banner/7.jpg" alt=""></a>
                                            </li>
                                            <li>
                                                <a class="p-0" href="shop-left-sidebar.html"><img
                                                        class="img-responsive w-100"
                                                        src="{{asset('assets/frontend/')}}/images/banner/8.jpg" alt=""></a>
                                            </li>
                                            <li>
                                                <a class="p-0" href="shop-left-sidebar.html"><img
                                                        class="img-responsive w-100"
                                                        src="{{asset('assets/frontend/')}}/images/banner/9.jpg" alt=""></a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
    ...
    <div class="inner">
        ...
        <div class="body customScroll">
            <ul class="minicart-product-list">
                <li>
                    <a href="single-product.html" class="image"><img src="{{asset('assets/frontend/')}}/images/product-image/1.jpg"
                ...
                <li>
                    <a href="single-product.html" class="image"><img src="{{asset('assets/frontend/')}}/images/product-image/2.jpg"
                                                                     alt="Cart product Image"></a>
                    <div class="content">
                ...
                <li>
                    <a href="single-product.html" class="image"><img src="{{asset('assets/frontend/')}}/images/product-image/3.jpg"
                                                                     alt="Cart product Image"></a>
                    <div class="content">
...
<livewire:frontend.section.intro-slider/>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                ...
                <div class="single-feature">
                    <div class="feature-icon">
                        <img src="{{asset('assets/frontend/')}}/images/icons/1.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6 mb-md-30px mb-lm-30px mt-lm-30px">
                <div class="single-feature">
                    <div class="feature-icon">
                        <img src="{{asset('assets/frontend/')}}/images/icons/2.png" alt="">
                    </div>
                    <div class="feature-content">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-feature">
                    <div class="feature-icon">
                        <img src="{{asset('assets/frontend/')}}/images/icons/3.png" alt="">
                    </div>
                    <div class="feature-content">
...
<!-- Deal Area Start -->
<div class="deal-area deal-bg deal-bg-2" data-bg-image="{{asset('assets/frontend/')}}/images/deal-img/deal-bg-2.jpg">
    <div class="container ">
        <div class="row">
            <div class="col-12">
                <div class="deal-inner position-relative pt-100px pb-100px">
                    ...
                    <div class="deal-image">
                        <img class="img-fluid" src="{{asset('assets/frontend/')}}/images/deal-img/woman.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 mb-md-30px mb-lm-30px">
                <div class="single-blog">
                    <div class="blog-image">
                        <a href="blog-single-left-sidebar.html"><img src="{{asset('assets/frontend/')}}/images/blog-image/1.jpg"
            ...
            <div class="col-lg-4 mb-md-30px mb-lm-30px">
                <div class="single-blog ">
                    <div class="blog-image">
                        <a href="blog-single-left-sidebar.html"><img src="{{asset('assets/frontend/')}}/images/blog-image/2.jpg"
                                                                     class="img-responsive w-100" alt=""></a>
                    </div>
                    <div class="blog-text">
                        <div class="blog-athor-date">
            ...
            <div class="col-lg-4">
                <div class="single-blog">
                    <div class="blog-image">
                        <a href="blog-single-left-sidebar.html"><img src="{{asset('assets/frontend/')}}/images/blog-image/3.jpg"
                                                                     class="img-responsive w-100" alt=""></a>
                    </div>
                    <div class="blog-text">
                        <div class="blog-athor-date">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <p class="copy-text"> © {{now()->year}} <strong>Jesco</strong> Made With <i class="fa fa-heart"
                    ...
                    <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="{{asset('assets/frontend/')}}/images/product-image/zoom-image/1.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="{{asset('assets/frontend/')}}/images/product-image/zoom-image/2.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="{{asset('assets/frontend/')}}/images/product-image/zoom-image/3.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="{{asset('assets/frontend/')}}/images/product-image/zoom-image/4.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="swiper-container zoom-thumbs mt-3 mb-3">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="{{asset('assets/frontend/')}}/images/product-image/small-image/1.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="{{asset('assets/frontend/')}}/images/product-image/small-image/2.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="{{asset('assets/frontend/')}}/images/product-image/small-image/3.jpg" alt="">
                                </div>
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto"
                                         src="{{asset('assets/frontend/')}}/images/product-image/small-image/4.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
...
{{--<script src="{{asset('assets/frontend/')}}/js/plugins/venobox.min.js"></script>--}}
{{--<script src="{{asset('assets/frontend/')}}/js/plugins/ajax-mail.js"></script> -->--}}
